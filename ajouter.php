	...
	<div id="page">
		...
		<div class="gtco-section">
			<div class="gtco-container">
				...
				<form method="get" action="aj.php">
				 <div class="input-group">
                            <div class="input-group-prepend">
                                  <span class="input-group-text" id="">caracterstique de produit </span>
                            </div>
                             <input type="text" class="form-control" name="id" placeholder="id de produit">
                          <input type="text" class="form-control" name="name" placeholder="nom de produit">
                           <input type="text" class="form-control" name="cat" placeholder="categorie de produit">
