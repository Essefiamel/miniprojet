			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-2 col-xs-12">
						<div id="gtco-logo"><a href="index.html">PRODUITS</a></div>
					</div>
				...
				<form method="get" action="index.php">
				 <div class="input-group">
                            <div class="input-group-prepend">
                                  <span class="input-group-text" id="">nom de produit</span>
                            </div>
...
echo $html;
try{
    $con = new PDO('mysql:host=127.0.0.1;dbname=produits', 'root', '');
}catch(PDOException $e){
    die($e->getMessage());
}

$result = $con->query ("SELECT * FROM produit");
